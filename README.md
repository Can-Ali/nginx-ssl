...
server {
    listen 80;
	server_name automation-challenge.akmustafa.de;
    root /public_html/;
...
server {
    ...
    location ~ /.well-known/acme-challenge{
        ...
        location / {
        return 301 https://automation-challenge.akmustafa.de$request_uri;
    }
}
...
server {
     ...
     ssl on;
     server_tokens off;
     ssl_certificate /etc/nginx/ssl/live/automation-challenge.akmustafa.de/fullchain.pem;
     ssl_certificate_key /etc/nginx/ssl/live/automation-challenge.akmustafa.de/privkey.pem;
...
- Now we can reach our index.html file under automation-challenge.akmustafa.de address with valid TLS certificate.
...
automation-challenge.akmustafa.de address with valid TLS certificate.
